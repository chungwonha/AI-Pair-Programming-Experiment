...
@Data @Entity @NoArgsConstructor// Lombok annotation to create getters, setters, toString, equals, and hashCode methods
public class WashingtonPostEconomyArticleEntity extends WashingtonPostArticleEntity implements Analyzable{
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private int id;

    @Column(name = "article_type")
    private String articleType="Economy";

    //web-scraper-order,web-scraper-start-url,article_links,article_links-href,article_text
